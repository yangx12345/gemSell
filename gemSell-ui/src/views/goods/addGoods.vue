<template>
  <div class="app-container">
    <el-dialog
      :title="this.currentgood.goodId? '编辑商品':'添加商品'"
      ...
      <el-form ref="currentgood" :model="currentgood" :inline="true" label-width="120px" :rules="userRules">
        ...
        <el-form-item label="商品分类" prop="typeId">
          <treeselect v-model="currentgood.typeId" :options="options" style="width: 240px" />
        </el-form-item>
      ...
      >
        <el-upload
          ...
          <div
            slot="tip"
            class="el-upload__tip">只能上传jpg/png/jpeg文件，且不超过500kb</div>
        </el-upload>
      </el-form-item>
         <el-form-item label="商品介绍" prop="introduce">
          <el-input v-model="currentgood.introduce" type="textarea"
          :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入" />
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="onCancel()">取 消</el-button>
        <el-button type="primary"  @click="onSubmit">{{ this.currentgood.goodId?'保存':'添加' }}</el-button>
      </span>
    </el-dialog>
