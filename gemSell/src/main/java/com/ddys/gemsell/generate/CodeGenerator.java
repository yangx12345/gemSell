package com.ddys.gemsell.generate;
...
public class CodeGenerator {
	 ...
	 * 数据库连接信息
	 **/
	private static final String DB_URL = "jdbc:mysql://localhost:3306/gemsell?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
	 ...
	 * 包名
	 **/
	private static final String PACKAGE_NAME = "com.ddys.gemsell";
	/**
	 * 基础controller
	 **/
	 ...
	 * 作者
	 **/
	private static final String AUTHOR = "ddys";
	...
	public static void main(String[] args) {
		...
		//设置要映射的表名，可传多个
		strategy.setInclude("indent");
		//strategy.setInclude("user","address","authenticate","cart","goods","order","tb_city","tb_province","type");
		//去掉表前缀
